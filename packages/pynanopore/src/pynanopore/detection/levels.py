...
def analyze_event_levels(
    ...
    *,
    ...
    if len(seg) < min_samples or max_levels < 1:
        ...
        return LevelFeatures(n_levels=1.0, level1_current=mean, level1_fraction=1.0, level_rms=0.0)
    ...
    # Order centers by |c - i0| descending depth (deepest first as level1)
